...
public class RecognizeDynamicRHand : MonoBehaviour
{
    ...
    RecognizeStaticRHand rightHGesture;
    ...
    void Start()
    {
        ...
        rightHGesture = GetComponent<RecognizeStaticRHand>();
    ...
    void Update()
    {
        ...
        {
            if (handInitializer.isInitialized && !string.IsNullOrEmpty(rightHGesture.currentGesture_R.name) && !pathsInstantiated_R)
            {
